...
//                   }else{
//                     */
//                     if(!isset($absen[$j]['noid'])){
//                       $pegawai[$i]['jam_masuk'] = '';                            
//                       $pegawai[$i]['jam_pulang'] = '';
//                     }else{
//                       if($pegawai[$i]['noid'] <= 10){
//                            $x = 1010 + intval($pegawai[$i]['noid']);
//                           }
//                       if(intval($absen[$j]['noid']) == $x){
//                         if(date('H:i:s', strtotime($absen[$j]['jam'])) <= date('H:i:s', strtotime('12:00:00'))){
//                           $pegawai[$i]['jam_masuk'] = $absen[$j]['jam'];    
//                         }

//                         else{
//                           //if(isset($pegawai[$i]['jam_masuk'])){
//                           if(date('H:i:s', strtotime($absen[$j]['jam'])) >= date('H:i:s', strtotime('12:00:00'))){
...
//                       if(($p['jam_masuk'] == '') or ($p['jam_pulang'] == '')){
//                         $pegawaiabsen = array(
