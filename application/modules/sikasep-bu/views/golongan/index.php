...
<div class="text-center golongan">
  ...
  <select name="id_level_golongan" class="btn btn-info p-10 " onchange="cari_golongan()">
      ...
      <?php endforeach; ?>
        ...
        <table class="table table-bordered table-striped" id="myTableGolongan">
...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       var userDataTable = $('#myTableGolongan').DataTable({
         'processing': true,
         'serverSide': true,
         'serverMethod': 'post',
         ...
         'ajax': {
            ...
            'data': function(data){
               data.searchGol = $('[name="id_level_golongan"]').val();
            }
         },
         'columns': [
            { data: 'username' },
       ...
       $('[name="id_level_golongan"]').change(function(){
          userDataTable.draw();
       });
    });
    </script>
