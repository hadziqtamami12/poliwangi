              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <!-- <span class="mb-0 text-sm  text-primary font-weight-bold"><?= $this->session->userdata('level_user'); ?></span> -->
                    <span class="mb-0 text-sm  text-primary font-weight-bold"><?= $this->session->userdata('nama_user'); ?></span>
