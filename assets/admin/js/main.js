$(function(){
    ...
    var base_url='localhost/poliwangi/sikasep/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        // events: base_url+'Status_Hari/getEvents',

        // Handle Day Click
        dayClick: function(date, event, view) {
            currentDate = .fullCalendar.formatDate(event.start, "Y-MM-DD HH:mm:ss");
         ...
         eventDrop: function(event, delta, revertFunc) {  
               ...
               $.post(base_url+'Status_Hari/dragUpdateEvent',{                            
                id:event.id,
    ...
    $('.modal').on('click', '#add-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'Status_Hari/addEvent', {
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'Status_Hari/updateEvent', {
                id: currentEvent._id,
                title: $('#title').val(),
                description: $('#description').val(),
                color: $('#color').val(),
    ...
    $('.modal').on('click', '#delete-event',  function(e){
        $.get(base_url+'Status_Hari/deleteEvent?id=' + currentEvent._id, function(result){
            $('.modal').modal('hide');
            $('#calendar').fullCalendar("refetchEvents");
        });
    });
